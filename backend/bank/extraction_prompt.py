...
def page_prompt() -> str:
    ...
    return (
        ...
        "  rawText — the stem copied verbatim, WITHOUT the printed question "
        "number, WITHOUT any visible marks (no '[1]', '(2 marks)', trailing "
        "mark digits) and WITHOUT option labels.\n"
        ...
        "for options/subparts. Draw the box TIGHT around the artwork itself — "
        "include the figure's own internal labels, but exclude question text, "
        "option lines, and mark digits above or below the figure.\n\n"
