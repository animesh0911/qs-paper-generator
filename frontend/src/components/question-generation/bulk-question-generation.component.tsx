...
export function BulkQuestionGenerationSetup({
  ...
  const reviewableBatches = reviewableGenerationBatches(batches);
...
export function GenerationProgressWorkspace({
  ...
  const {
    ...
    canGenerateAnother: batchCanGenerateAnother,
    generateAnotherLabel,
  } = generationProgressView(batch, visibleCandidates.length);
