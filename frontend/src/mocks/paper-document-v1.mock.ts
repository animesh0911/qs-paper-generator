...
export const mockPaperDocumentV1 = {
  ...
  paper: {
    ...
    instructionBlocks: [
      {
        blockId: 'instruction_mock_001',
        blockType: 'instruction',
        text: 'Maximum Marks: 30. Time allowed: 3 hours.',
        editable: true,
      },
      {
        blockId: 'instruction_mock_002',
        blockType: 'instruction',
        text: 'All questions are compulsory unless an internal choice is provided.',
        editable: true,
      },
    ],
    sections: [
      {
        ...
        marks: 2,
        instructions: 'Questions 1 and 2 are objective type questions.',
        slots: [
          {
            slotId: 'slot_A_01',
            displayNumber: '1',
      ...
      },
      {
        ...
        marks: 4,
        instructions: 'Questions 3 and 4 carry 2 marks each.',
        slots: [
          {
            slotId: 'slot_B_01',
            displayNumber: '3',
      ...
      },
      {
        ...
        marks: 10,
        instructions: 'Questions 5 and 6 carry 5 marks each.',
        slots: [
          {
            slotId: 'slot_C_01',
            displayNumber: '5',
      ...
      },
      {
        sectionId: 'D',
        title: 'Section D',
        subtitle: 'Competency-Based Questions',
        marks: 4,
        instructions: 'Question 7 is a case-based question.',
        slots: [
          {
            slotId: 'slot_D_01',
            displayNumber: '7',
      ...
      },
      {
        sectionId: 'E',
        title: 'Section E',
        subtitle: 'Source-Based Questions',
        marks: 10,
        instructions: 'Questions 8 and 9 include diagram/table references.',
        slots: [
          {
            slotId: 'slot_E_01',
            displayNumber: '8',
